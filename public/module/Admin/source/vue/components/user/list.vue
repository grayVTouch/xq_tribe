                        ...
                        <div class="con">
                            ...
                            <div class="filter-options">
                                ...
                                <div class="option">
                                    ...
                                    <div class="value"><input type="text" v-model="filter.username" class="form-text"></div>
                                </div>

                                <div class="option">
                                    <div class="field">性别：</div>
                                    <div class="value">
                                        <RadioGroup v-model="filter.sex">
            ...
            <div class="res">
                <div class="list">
                    <div class="component-title">
                        ...
                        <div class="right">
                            <button class="btn btn-8" @click="$his.to($_route.controller + '/add')">新增用户</button>
                        </div>
                    </div>
                    ...
                    <table class="line-tb">
                        ...
                        <tr v-for="v in list" @click="selectLineEvent" :data-id="v.id" :key="v.id">
                            ...
                            <td class="multiple-rows">
                                ...
                                <div class="row"><img :src="v.avatar_url" class="image preview"></div>
                            </td>
                            <td class="multiple-rows">
                                <div class="row">【用户名】{{ v.username }}</div>
                                <div class="row">【性别】{{ v.sex_explain }}</div>
                            </td>
                            <td class="multiple-rows">
                                <div class="row">【注册时间】{{ v.create_time }}</div>
